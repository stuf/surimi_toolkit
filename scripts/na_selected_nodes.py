...
class NA_OT_surimi_normalize_image_nodes(T.Operator):
    bl_idname = 'surimi.experimental_normalize_image_nodes'
...
def register():
    bpy.utils.register_class(NA_OT_surimi_normalize_image_nodes)


def unregister():
    bpy.utils.unregister_class(NA_OT_surimi_normalize_image_nodes)
